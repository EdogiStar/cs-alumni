...
<html lang="en">
  <head>
    ...
    <title>CS ALUMNI IBBUL - Home</title>
  ...
  <body>
      ...
      <section class="flexslider">
        <ul class="slides">
          <li style="background-image: url(img/IBBUL1.jpg)" class="overlay">
            <div class="container">
              <div class="row">
          ...
          <li style="background-image: url(img/alumni1.webp)" class="overlay">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="probootstrap-slider-text text-center">
          ...
          <li style="background-image: url(img/alumni2.jpg)" class="overlay">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="probootstrap-slider-text text-center">
                    <h1 class="probootstrap-heading probootstrap-animate">Helping Each of Our Members Fulfill the Potential</h1>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left section-heading probootstrap-animate">
              <h2>Welcome to Group of Excellence</h2>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
              <div class="probootstrap-counter-wrap">
                ...
                <div class="probootstrap-text">
                  ...
                  <span class="probootstrap-counter-label">Certified Executives</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
               ...
               <div class="probootstrap-counter-wrap">
                ...
                <div class="probootstrap-text">
                  ...
                  <span class="probootstrap-counter-label">Members Satisfaction</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center section-heading probootstrap-animate">
              ...
              <p class="lead">CS IBBUL ALUMNI executives are a set of trustworthy individuals who were elected into office not just as a result of their capabilities but honesty and dedication towards the development of the association.</p>
            </div>
          </div>
          <!-- END row -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center section-heading probootstrap-animate">
              ...
              <p class="lead">Below are a list of few testimonials from our members</p>
            </div>
          </div>
          <!-- END row -->
          <div class="row">
